...
ok 34 - UUID v1 from PostgreSQL timestamptz overflows correctly
ok 35 - int8 UUIDs generation is consistent
ok 36 - int8 UUIDs generation is consistent
ok 37 - create_from_int8 handles nulls properly
...
ok 43 - UUID v1 are correctly reversed into components
