...
ok 34 - UUID v1 from PostgreSQL timestamptz overflows as expected
ok 35 - UUID v1 from PostgreSQL int8 overflows as expected
ok 36 - int8 UUIDs generation is consistent
ok 37 - int8 UUIDs generation is consistent
ok 38 - create_from_int8 handles nulls properly
...
ok 42 - Planner recognizes uuid_v1_ops index as usable for the ~>= operator
ok 43 - Planner recognizes uuid_v1_ops index as usable for the = operator
ok 44 - UUID v1 are correctly reversed into components
